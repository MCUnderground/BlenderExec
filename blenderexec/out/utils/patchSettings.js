...
exports.patchSettingsWithBlenderStubs = patchSettingsWithBlenderStubs;
const vscode = __importStar(require("vscode"));
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
async function patchSettingsWithBlenderStubs(wsRoot, stubPath) {
    ...
    const existing = settings['python.analysis.extraPaths'] || [];
    ...
    if (!normalized.includes(path.normalize(stubPath))) {
        ...
        vscode.window.showInformationMessage('Blender stubs enabled for this workspace. Start writing.');
    }
}
